...
import com.ss.generator.ENTITY_KEY_CODE;
import com.ss.utils.Identifiable;

/**
 * This class used to generate hibernate sequences for table string id column
 * @author Gokulan R
 *
 */
public abstract class AbstractStringIDGenerator implements IdentifierGenerator , Configurable{
    ...
    public void configure(
        ...
        String globalEntityIdentifierPrefix =
            configurationService.getSetting( "entity.identifier.prefix", String.class, globalDefaultEntityIdentifierPrefix+sequencePrefix_seperator);

        sequencePrefix = ConfigurationHelper.getString(
                SEQUENCE_PREFIX,
                params,
                globalEntityIdentifierPrefix)+sequencePrefix_seperator;
	...
	private Serializable buildStringNextValue(String prefix,int nextValue) {
		...
		System.out.println(" Custome Sequence Generator :" +result);
