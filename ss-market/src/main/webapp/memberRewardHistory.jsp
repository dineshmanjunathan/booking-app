					...
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						<div class="product-payment-inner-st">
							<ul id="myTabedu1" class="tab-review-design">
								<center><li class="active"><a href="">Reward History</a></li></center>
							</ul>
                                ...
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    <div id="toolbar">
                                     ...
                                     <thead>
                                        ...
                                        <tbody> 
                                        <c:forEach var="details" items="${rewardList}" varStatus="status">
                                            <tr>
												<td>${details.memberid}</td>
												<td>${details.point}</td>
												<td>${details.rewardedOn}</td> 		     								 
                                            </tr> 
                                        </c:forEach>
                                        </tbody>
                                    </table>
